package M2.TransportesGUI;

import M2.libreria.Lugar;
import M2.libreria.Objeto;
import M2.libreria.Posicion;
...
public class Avioneta extends JDialog {
    ...
    public Avioneta() {
        ...
        buttonAddObject.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Image image = null;
                try {
                    image = ImageIO.read(new File("small-plane.png"));
